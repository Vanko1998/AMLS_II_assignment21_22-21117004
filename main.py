...
tr_avg_k,v_avg_k,t_avg_k=B.train_all_event(all_event,twitter_df,'english',4,60)
print('knn training average accuracy:')
print(tr_avg_k)
...
tr_avg_k_a,v_avg_k_a,t_avg_k_a=B.train_all_event(all_event_a,twitter_df_a,'arabic',3,34)
print('knn training average accuracy:')
print(tr_avg_k_a)
print('knn valid average accuracy:')
print(v_avg_k_a)
